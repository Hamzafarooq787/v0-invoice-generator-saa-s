    ...
    <section className="border-t border-border py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="mx-auto mb-12 max-w-2xl text-center">
          <h2 className="mb-4 text-3xl font-bold text-foreground md:text-4xl">How Our Invoice Software Works</h2>
          <p className="text-lg text-muted-foreground">Create professional invoices in four simple steps</p>
        </div>
